...
- **Date** is the date and time the member performed the activity
- **Member Name** is the name of the member
- **Activity** is an activity that members do such as delete targets or others
- **IP Address** is a unique numeric address used to identify the device from member
- **OS** is the "Operating System" that members use
- **Browser** is the software that members use
