...
- ***Date*** adalah tanggal dan waktu anggota melakukan aktivitas
- ***Member Name*** adalah nama anggota
- ***Activity*** adalah kegiatan yang dilakukan anggota seperti menghapus target atau lainnya
- ***IP Address*** adalah alamat numerik unik yang digunakan untuk mengidentifikasi perangkat dari anggota
- ***OS*** adalah "Sistem Operasi" yang digunakan anggota
- ***Browser*** adalah perangkat lunak yang digunakan anggota
