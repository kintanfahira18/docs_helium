...
Wordlists that can only be edited are wordlists that have been created by the user previously.
...
This action is permanent and cannot be undone. Remove your Wordlist only when you are sure.
...
To delete one of the wordlists, the user can only delete the wordlist that was created previously.
